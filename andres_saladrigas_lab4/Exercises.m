...
%%%
disp('there are 3 scrips name exercise 1, 2 ,3 and 4 respectively.')
disp('There were to many variables, plots and information in a single.') 
disp('I divided them for you to understand it easily. ')